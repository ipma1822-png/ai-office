...
function boot(){installCaptureCopy();apply();const root=$('genNewsBoard');if(root)new MutationObserver(queue).observe(root,{childList:true,subtree:true});window.addEventListener('storage',e=>{if(e.key===NEWS_KEY)queue()});setInterval(apply,2500)}

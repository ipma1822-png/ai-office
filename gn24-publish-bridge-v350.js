...
function loadReceipt(){if(document.getElementById('gn24PublishReceipt360Script'))return;const s=document.createElement('script');s.id='gn24PublishReceipt360Script';s.src=RECEIPT_MODULE;s.defer=true;document.head.appendChild(s)}
...
if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',()=>{loadReceipt();setInterval(refresh,800)});else{loadReceipt();setInterval(refresh,800)}
})();